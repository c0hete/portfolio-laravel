...
<section class="min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
    ...
    <p class="max-w-2xl text-lg text-slate-400 mb-10 leading-relaxed">
        Desarrollador Backend especializado en **PHP/Laravel** y **Arquitectura de Infraestructura**. 
        Actualmente operando plataformas de alta disponibilidad y finalizando **Ingeniería en Ciberseguridad**.
    </p>

    <div class="flex flex-wrap justify-center gap-4">
        <div class="px-4 py-2 rounded-lg bg-slate-900 border border-slate-800 text-sm font-mono shadow-xl">

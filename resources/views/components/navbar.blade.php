<nav class="border-b border-white/5 bg-[#020617]/80 backdrop-blur-md sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
        ...
        <div class="hidden md:flex space-x-7 text-[11px] font-medium items-center tracking-widest uppercase">
            ...
            <a href="https://github.com/c0hete" target="_blank" rel="noopener noreferrer" aria-label="GitHub" class="text-slate-500 hover:text-cyan-400 transition-colors">
            ...
            <a href="https://linkedin.com/in/josealvaradomazzeies" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="text-slate-500 hover:text-cyan-400 transition-colors">

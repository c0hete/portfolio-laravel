...
{{-- Enlaces de contacto y redes (lo que busca un reclutador) --}}
        <div class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-3 text-sm">
                <a href="https://github.com/c0hete" target="_blank" rel="noopener noreferrer" data-umami-event="github_footer" class="group flex items-center gap-3 text-slate-400 hover:text-cyan-400 transition-colors">
                ...
                <a href="https://linkedin.com/in/josealvaradomazzeies" target="_blank" rel="noopener noreferrer" data-umami-event="linkedin_footer" class="group flex items-center gap-3 text-slate-400 hover:text-cyan-400 transition-colors">
